...
📁 Project Structure
  ...
  │-- periodic.html      → Dynamic Periodic Table  :contentReference[oaicite:1]{index=1}
  
  │-- solar.html         → Solar System Showcase  :contentReference[oaicite:2]{index=2}
...
🛠️ Technologies Used
 ...
 🚀 How to Run Locally
    ...
    git clone https://github.com/Krishna200803/Science-Pathshaala.git
